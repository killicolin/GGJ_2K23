...
use resource::{LastShot, Score, TotalKilled, TotalSpawned, TotalToSpawn, ChunksMap};
use systems::{
    in_game::{
        ...
        setup_in_game, transform_update, wave_is_done_emit, make_map, load_chunks, GameOverEvent, MobSpawnEvent,
...
pub fn run(width: f32, height: f32) {
    ...
    .insert_resource(ChunksMap {chunks: HashMap::new()})
